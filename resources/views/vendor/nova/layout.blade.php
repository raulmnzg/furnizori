...
<body class="min-w-site bg-white text-90 font-medium min-h-full">
<div id="nova">
  <div v-cloak class="flex min-h-screen">
    <!-- Sidebar -->
    <div class="min-h-screen bg-black flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6">
    ...
    <!-- Content -->
    <div class="content">
      <div class="flex items-center relative shadow h-header bg-white z-20 px-view border-bottom">
